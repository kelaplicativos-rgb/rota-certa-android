...
HELPER = PKG / 'FarolOcrMultilineAddressStage45.kt'
...
old = '''                                val blocksStage19 = FarolVisualPriority0189.cluster("stage19-ocr:$serialStage19", fragmentsStage19)
                                    .map { groupStage19 ->
...
'''
new = '''                                val blocksStage19 = FarolVisualPriority0189.cluster("stage19-ocr:$serialStage19", fragmentsStage19)
                                    .map { groupStage19 ->
...
'''
service = once(service, old, new, 'Stage45 OCR cluster reconstruction integration')
SERVICE.write_text(service, encoding='utf-8')
print('stage45_ocr_multiline_address=PASS spatial_cluster_only=true semantic_gate_unchanged=true')

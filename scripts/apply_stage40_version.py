...
version_assertions = [
    (
        ...
        'assertTrue(s.contains("versionCode = 5494")); assertTrue(s.contains("versionName = \\"0.1.210\\""))',
    ...
    (
        ...
        'assertTrue(b.contains("versionCode = 5494"));assertTrue(b.contains("versionName = \\"0.1.210\\""))',
...
for test_path, old, new, label in version_assertions:
    ...
    if count != 1:
        raise SystemExit(f"{label}: expected 1 Stage38 assertion, got {count}")
...
print("stage40_version=PASS versionName=0.1.211 versionCode=5495 inherited_version_assertions=2")

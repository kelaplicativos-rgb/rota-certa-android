...
if (oldTarget in sessionDiagnosticSource) {
    sessionDiagnosticSource = sessionDiagnosticSource.replace(oldTarget, newTarget)
}
if (oldReplacementStart in sessionDiagnosticSource) {
    sessionDiagnosticSource = sessionDiagnosticSource.replace(oldReplacementStart, newReplacementStart)
}
if (oldReplacementEnd in sessionDiagnosticSource) {
    sessionDiagnosticSource = sessionDiagnosticSource.replace(oldReplacementEnd, newReplacementEnd)
}

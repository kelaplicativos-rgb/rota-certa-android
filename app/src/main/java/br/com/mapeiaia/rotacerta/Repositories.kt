...
class SettingsRepository(private val context: Context) {
    ...
    val settings: Flow<AppSettings> = context.dataStore.data.map { prefs ->
        AppSettings(
            ...
            requireRegisteredRideCard = prefs[requireRegisteredRideCard] ?: false,
            proximityAlertsEnabled = prefs[proximityAlertsEnabled] ?: true,
            proximityAlertDistanceMeters = (prefs[proximityAlertDistanceMeters] ?: 500).coerceIn(100, 2000),
    ...
    suspend fun saveSettings(settings: AppSettings) {
        context.dataStore.edit { prefs ->
            ...
            prefs[proximityAlertDistanceMeters] = settings.proximityAlertDistanceMeters.coerceIn(100, 2000)

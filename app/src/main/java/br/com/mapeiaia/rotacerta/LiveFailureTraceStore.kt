...
object LiveFailureTraceStore {
    ...
    fun recordRead(
        ...
        if (!DiagnosticRuntimeGate.isEnabled(nowMillis)) return // manual_gate_recordRead_checklist_4
    ...
    fun recordTrace(
        ...
        if (!DiagnosticRuntimeGate.isEnabled(nowMillis)) return // manual_gate_recordTrace_checklist_4
    ...
    fun recordStep(
        ...
        if (!DiagnosticRuntimeGate.isEnabled(nowMillis)) return // manual_gate_recordStep_checklist_4
        synchronized(lock) {
            val session = currentSessionLocked() ?: newSessionLocked(
                packageName = packageName.orEmpty(),
                screenHash = screenHash,
    ...
    fun recordGeocode(
        ...
        if (!DiagnosticRuntimeGate.isEnabled(nowMillis)) return // manual_gate_recordGeocode_checklist_4
    ...
    fun recordRoute(
        ...
        if (!DiagnosticRuntimeGate.isEnabled(nowMillis)) return // manual_gate_recordRoute_checklist_4
    ...
    fun recordDecision(
        ...
        if (!DiagnosticRuntimeGate.isEnabled(nowMillis)) return // manual_gate_recordDecision_checklist_4
        synchronized(lock) {
            val session = currentSessionLocked() ?: newSessionLocked(
                packageName = packageName.orEmpty(),
                screenHash = screenHash,

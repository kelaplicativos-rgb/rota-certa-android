...
object UniversalScreenAddressParser {
    private val streetStartRegex = Regex(
        "(?:^|[\\s:;])((?:r\\.|av\\.|rua|avenida|alameda|travessa|estrada|rodovia|praca|praça|largo|via|passagem|viela|beco|marginal|servidao|servidão)(?:\\b|(?=\\s)))",
        RegexOption.IGNORE_CASE,
    )
    private val parenthesizedStreetRegex = Regex(
        "\\(((?:r\\.|av\\.|rua|avenida|alameda|travessa|estrada|rodovia|praca|praça|largo|via|passagem|viela|beco|marginal|servidao|servidão)(?:\\b|(?=\\s)))",
        RegexOption.IGNORE_CASE,
    )
    ...
    private val danglingStreetPrefixRegex = Regex(
        "(?:^|[\\s:(])(?:r\\.|av\\.|rua|avenida|alameda|travessa|estrada|rodovia|praca|praça|largo|via|passagem|viela|beco|marginal|servidao|servidão)\\s*[.:;,\\-–—]*$",
        RegexOption.IGNORE_CASE,
    )

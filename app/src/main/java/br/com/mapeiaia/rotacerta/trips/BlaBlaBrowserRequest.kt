 ...
 */
internal enum class BlaBlaBrowserOperation {
    CAPTURE,
    NAVIGATION,
    REMOTE_WRITE,
}
...
internal enum class BlaBlaBrowserRequest(
    ...
    val operation: BlaBlaBrowserOperation = BlaBlaBrowserOperation.CAPTURE,
) {
    ...
    TRIP_OPEN("trip_open.js", BlaBlaBrowserOperation.NAVIGATION),
    ...
    PASSENGER_OPEN("passenger_open.js", BlaBlaBrowserOperation.NAVIGATION),
    ...
    MESSAGE_PASSENGER_OPEN("message_passenger_open.js", BlaBlaBrowserOperation.NAVIGATION),
    MESSAGE_THREAD("message_thread.js"),

    ARCHIVED_RIDE_LIST("archived_ride_list.js"),
    ARCHIVED_RIDE_OPEN("archived_ride_open.js", BlaBlaBrowserOperation.NAVIGATION),

    PAGE_STATE("page_state.js"),
    DOM_SNAPSHOT("dom_snapshot.js"),
    ;

    val mutatesRemoteState: Boolean
        get() = operation == BlaBlaBrowserOperation.REMOTE_WRITE

    val isCollectionStep: Boolean
        get() = operation != BlaBlaBrowserOperation.REMOTE_WRITE
}

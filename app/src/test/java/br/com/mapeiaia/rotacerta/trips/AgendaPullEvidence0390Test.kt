...
class AgendaPullEvidence0390Test {
    ...
    fun timelineRecordsEveryResolvedOutcomeAndRealListState() {
        ...
        assertTrue(activity.contains("outcome="))
        assertTrue(activity.contains("firstVisibleItemIndex="))
        assertTrue(activity.contains("firstVisibleItemScrollOffset="))
        assertTrue(activity.contains("canScrollBackward="))

...
class DirectionalProximityAlertEngineChecklist5Test {
    ...
    fun `radar a frente mostra contagem e fala uma vez`() {
        ...
        engine.check(emptyList(), listOf(radar), fix(longitude = -0.0018, heading = 90.0), settings(), { visual = it })
        engine.check(emptyList(), listOf(radar), fix(longitude = -0.0014, heading = 90.0), settings(), { visual = it })
    ...
    fun `radar em sentido contrario tambem aparece e fala`() {
        ...
        engine.check(emptyList(), listOf(radar), fix(longitude = 0.0018, heading = 270.0), settings(), { visual = it })
        engine.check(emptyList(), listOf(radar), fix(longitude = 0.0014, heading = 270.0), settings(), { visual = it })
